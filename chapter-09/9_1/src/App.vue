  ...
  <main-layout>
    ...
    <section class="section">
      <div class="container">
        ...
        <b-field grouped>
          <b-field expanded label="Phone">
            <b-input v-model="phone" type="tel" />
          </b-field>
          <b-field expanded label="Cellphone">
            <b-input v-model="cellphone" type="tel" />
          </b-field>
        </b-field>
        ...
        <b-field grouped>
          <b-field expanded label="Zipcode">
            <b-input v-model="zipcode" type="tel" />
          </b-field>
        ...
        <hr />
        <b-field grouped>
          <b-field expanded label="Username">
